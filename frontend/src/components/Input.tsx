        ...
        <div className={`space-y-1.5 ${containerClassName}`}>
            ...
            <div className="relative">
                <input
                    id={inputId}
                    ref={ref}
                    className={`input-field py-3 px-4 text-base focus:ring-2 bg-gray-50 focus:bg-white transition-colors w-full ${error ? 'border-red-500 focus:ring-red-200 bg-red-50' : ''} ${className}`}
                    {...props}
                />
            </div>
